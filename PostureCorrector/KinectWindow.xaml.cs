...
namespace Microsoft.Samples.Kinect.KinectExplorer
{
    ...
    public partial class KinectWindow : Window
    {
        ...
        public void WindowClosed(object sender, EventArgs e)
        {
            ...
            OnChildReturnEventInKinectWindow(returnValue);//값 리턴
            returnValue = 0;//개새끼
        }

        

        public static int returnValue = -1;//이 값으로 가져옴!





        public delegate void OnChildReturnValueInKinectWindow(int ret);
        public event OnChildReturnValueInKinectWindow OnChildReturnEventInKinectWindow;
        /// <summary>
        ...
        void cw_returnValueWithClose(int ret)
        {
            returnValue = ret;
            this.Close();
        }
