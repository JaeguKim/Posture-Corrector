...
namespace Microsoft.Samples.Kinect.KinectExplorer
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public int postureIndex = 0;
        public int returnOut = 0;
        public int returnIn = 0;
        public delegate void OnChildReturnValueHandlerInMainWindow(int ret);
        public event OnChildReturnValueHandlerInMainWindow OnChildReturnValueEventInMainWindow;
        ...
        public void WindowClosed1(object sender, EventArgs e)
        {
            this.Close();
            OnChildReturnValueEventInMainWindow(sensorItem.returnCodeFromKinectWindow);
