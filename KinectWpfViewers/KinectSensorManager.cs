...
namespace Microsoft.Samples.Kinect.WpfViewers
{
    ...
    public class KinectSensorManager : Freezable
    {
        ...
        public static int postureIndex1 = 0;

        public delegate void OnChildReturnValueInKinectSensorManager(int ret);
        public static event OnChildReturnValueInKinectSensorManager OnChildReturnValueEventInKinectSessorManager;
        ...
        public static void returnWithSuccessValue(int ret)
        {
            OnChildReturnValueEventInKinectSessorManager(ret);
        }
